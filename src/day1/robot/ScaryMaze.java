...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		//1. make a maze image and drop it into your default package http://pixlr.com/editor/   800*600
		maze = ImageIO.read(getClass().getResource("Russ.jpg"));
...
// addMouseMotionListener(this)
	...
	private void scare() {
		...
		//7. find a scary sound and put it in the "default package" where you put your maze picture. You can search freesound.org or there are some on Google Drive under “sounds”.
